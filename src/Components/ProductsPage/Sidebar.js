...
const Sidebar = (props) => {
    const navVisibility = useSelector(
    ...
    const hideSideBar = () => {
        props.changeSidebarVisibility(false);
    };
    ...
    return (
        <aside
            className={
                props.sidebarVisibility && navVisibility && cartVisibility
                    ? ""
                    : "hideSidebar"
            }
        >
            <section className="filter">
                <button className="hideSidebarButton" onClick={hideSideBar}>
                    <span
                        className="iconify"
